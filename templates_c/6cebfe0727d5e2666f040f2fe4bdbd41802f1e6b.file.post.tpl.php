<?php /* Smarty version Smarty-3.1.13, created on 2013-07-31 18:11:31
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['user']['name'];?>
  ...
  <div class="media-body">
    ...
    <?php if ($_smarty_tpl->tpl_vars['post']->value['thumbnail_pic']){?>
      <div class="thumbnail span2">
        <img class="media-object" src="<?php echo $_smarty_tpl->tpl_vars['post']->value['thumbnail_pic'];?>
">
      </div>
    <?php }?>
    <label class="pull-left span12"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['post']->value['created_at'],"%y-%m-%d  %T");?>
</label> 
   </div>
